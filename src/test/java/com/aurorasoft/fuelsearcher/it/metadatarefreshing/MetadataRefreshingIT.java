package com.aurorasoft.fuelsearcher.it.metadatarefreshing;
...
import com.aurorasoft.fuelsearcher.it.metadatarefreshing.model.argumentsprovider.DocumentPropertyMetadataViewsProvider;
...
public final class MetadataRefreshingIT extends AbstractContextTest {
    private static final String HQL_QUERY_TO_FIND_ALL_PROPERTY_METADATA_VIEWS = "SELECT new "
            + "com.aurorasoft.fuelsearcher.it.metadatarefreshing.model.PropertyMetadataView("
