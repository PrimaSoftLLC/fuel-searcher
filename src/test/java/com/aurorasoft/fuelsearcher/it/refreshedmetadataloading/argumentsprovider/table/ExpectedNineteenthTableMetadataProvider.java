...
public final class ExpectedNineteenthTableMetadataProvider extends ExpectedTableMetadataProvider {
    private static final String TABLE_NAME = "ПРЕССОВАНИЕ СЕНА ПОСЛЕ КОМБАЙНА";

    public ExpectedNineteenthTableMetadataProvider() {
        super(TABLE_NAME);
    }
    ...
    protected Set<PropertyMetadata> providePropertiesMetadata() {
        return Set.of(
                ...
                PropertyMetadata.builder()
                        ...
                        .allowableValues(new String[]{"Fendt 515c"})
                        .build(),
                PropertyMetadata.builder()
                        .propertyName("механизм")
                        .allowableValues(new String[]{"KRONE Comprima CV 150 XC"})
                        .build(),
                PropertyMetadata.builder()
                        .propertyName("ширина захвата")
                        .allowableValues(new String[]{"5.5"})
                        .build(),
                PropertyMetadata.builder()
