...
public final class SeventeenthTableMetadataArgumentsProvider extends TablePropertyMetadataViewsProvider {
    private static final String TABLE_NAME = "ВОРОШЕНИЕ СЕНА";

    public SeventeenthTableMetadataArgumentsProvider() {
        super(TABLE_NAME);
    }
