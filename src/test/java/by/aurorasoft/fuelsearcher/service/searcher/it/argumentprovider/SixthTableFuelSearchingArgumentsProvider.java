...
public final class SixthTableFuelSearchingArgumentsProvider extends AbstractTableFuelSearchingArgumentsProvider {
        ...
        return Stream.of(
                Arguments.of(
                        Specification.builder()
                                ...
                                .build(),
                        optionalFuelFactory.apply(22.9, 12.5)
                ),
                Arguments.of(
                        Specification.builder()
                                .tableName("ЛУЩЕНИЕ И ДИСКОВАНИЕ МНОГОЛЕТНИХ ТРАВ")
                                ...
                                .processingDepth("Глубина обработки 6...8 см")
                                .build(),
                        optionalFuelFactory.apply(15.5, 12.8)
                ),
                Arguments.of(
                        Specification.builder()
                                .tableName("ЛУЩЕНИЕ И ДИСКОВАНИЕ МНОГОЛЕТНИХ ТРАВ")
                                ...
                                .build(),
                        optionalFuelFactory.apply(15.4, 7.7)
                ),
